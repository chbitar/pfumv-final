...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_ETUDIANTSMASTER),
          REQUEST(ACTION_TYPES.UPDATE_ETUDIANTSMASTER),
          REQUEST(ACTION_TYPES.DELETE_ETUDIANTSMASTER)
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.DELETE_ETUDIANTSMASTER)
        ],
        'error message',
        state => {
          expect(state).toMatchObject({
  ...
  describe('Successes', () => {
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_ETUDIANTSMASTER),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_ETUDIANTSMASTER_LIST actions', async () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_ETUDIANTSMASTER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_ETUDIANTSMASTER)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_ETUDIANTSMASTER),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.CREATE_ETUDIANTSMASTER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.CREATE_ETUDIANTSMASTER)
        },
        {
          type: SUCCESS(ACTION_TYPES.CREATE_ETUDIANTSMASTER),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.UPDATE_ETUDIANTSMASTER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.UPDATE_ETUDIANTSMASTER)
        },
        {
    ...
    it('dispatches ACTION_TYPES.DELETE_ETUDIANTSMASTER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.DELETE_ETUDIANTSMASTER)
        },
        {
          type: SUCCESS(ACTION_TYPES.DELETE_ETUDIANTSMASTER),
          payload: resolvedObject
