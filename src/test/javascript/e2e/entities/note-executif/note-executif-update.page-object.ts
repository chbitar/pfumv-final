...
export default class NoteExecutifUpdatePage {
  pageTitle: ElementFinder = element(by.id('pfumv10App.noteExecutif.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  semestreSelect: ElementFinder = element(by.css('select#note-executif-semestre'));
  noteCC1Input: ElementFinder = element(by.css('input#note-executif-noteCC1'));
  noteCC2Input: ElementFinder = element(by.css('input#note-executif-noteCC2'));
  noteFinalInput: ElementFinder = element(by.css('input#note-executif-noteFinal'));
  dateInput: ElementFinder = element(by.css('input#note-executif-date'));
  userSelect: ElementFinder = element(by.css('select#note-executif-user'));
  moduleSelect: ElementFinder = element(by.css('select#note-executif-module'));
