...
export default class NoteLicenceUpdatePage {
  pageTitle: ElementFinder = element(by.id('pfumv10App.noteLicence.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  semestreSelect: ElementFinder = element(by.css('select#note-licence-semestre'));
  noteCC1Input: ElementFinder = element(by.css('input#note-licence-noteCC1'));
  noteCC2Input: ElementFinder = element(by.css('input#note-licence-noteCC2'));
  noteFinalInput: ElementFinder = element(by.css('input#note-licence-noteFinal'));
  dateInput: ElementFinder = element(by.css('input#note-licence-date'));
  userSelect: ElementFinder = element(by.css('select#note-licence-user'));
  moduleSelect: ElementFinder = element(by.css('select#note-licence-module'));
