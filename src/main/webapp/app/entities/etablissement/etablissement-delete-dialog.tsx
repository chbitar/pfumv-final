...
export interface IEtablissementDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class EtablissementDeleteDialog extends React.Component<IEtablissementDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.etablissementEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-etablissement" color="danger" onClick={this.confirmDelete}>
